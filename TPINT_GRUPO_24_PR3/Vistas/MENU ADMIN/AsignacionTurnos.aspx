                    ...
                    <div class="bloque-turno">
                        ...
                        <div class="columna-resumen">
                            ...
                            <div class="panel-resumen">
                                ...
                                <h4 class="text-center text-decoration-underline mb-4">Resumen del Turno
                                </h4>
                                ...
                                <table class="tabla-resumen">
                                    ...
                                    <tr>
                                        <td><b>Paciente:</b></td>
                                        <td>
                                            <asp:Label ID="lblPacienteResumen" runat="server" Text="Pendiente" /></td>
                                    </tr>

                                    <tr>
                                        <td><b>DNI:</b></td>
                                        <td>
                                            <asp:Label ID="lblDniResumen" runat="server" Text="Pendiente" /></td>
                                    </tr>

                                    <tr>
                                        <td><b>Especialidad:</b></td>
                                        <td>
                                            <asp:Label ID="lblEspecialidadResumen" runat="server" Text="Pendiente" /></td>
                                    </tr>

                                    <tr>
                                        <td><b>Médico:</b></td>
                                        <td>
                                            <asp:Label ID="lblMedicoResumen" runat="server" Text="Pendiente" /></td>
                                    </tr>

                                    <tr>
                                        <td><b>Fecha:</b></td>
                                        <td>
                                            <asp:Label ID="lblFechaResumen" runat="server" Text="Pendiente" /></td>
                                    </tr>

                                    <tr>
                                        <td><b>Horario:</b></td>
                                        <td>
                                            <asp:Label ID="lblHorarioResumen" runat="server" Text="Pendiente" /></td>
                                    </tr>
